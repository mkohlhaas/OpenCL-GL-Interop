...
void clContextCreationCB(const char *err, const void *priv, size_t cb, void *userData) {
...
void initCl(GLFWwindow *window) {
  ...
  cl_context ctx = clCreateContext(properties, 1, &device, clContextCreationCB, NULL, &err);
